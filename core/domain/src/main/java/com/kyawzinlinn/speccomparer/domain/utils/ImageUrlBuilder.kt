...
object ImageUrlBuilder {
    ...
    private fun checkPath(path: String, productType: ProductType): String {
        return when (true) {
            ...
            (path.lowercase().contains("apple") && productType == ProductType.Soc) -> "${IMAGE_URL}soc/apple-mini.jpeg"
            ...
            path.lowercase().contains("amd-ryzen-threadripper") -> "${IMAGE_URL}cpu/amd-ryzen-threadripper.jpeg"
            ...
            path.lowercase().contains("intel-core-ultra-3") -> "${IMAGE_URL}cpu/intel-core-ultra-3.jpeg"
            path.lowercase().contains("intel-core-ultra-5") -> "${IMAGE_URL}cpu/intel-core-ultra-5.jpeg"
            path.lowercase().contains("intel-core-ultra-7") -> "${IMAGE_URL}cpu/intel-core-ultra-7.jpeg"
            path.lowercase().contains("intel-core-ultra-9") -> "${IMAGE_URL}cpu/intel-core-ultra-9.jpeg"
